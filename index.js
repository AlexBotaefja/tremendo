...
client.on("ready", async () => {
  ...
  client.user
    .setActivity(`Bot Oficial GracieBot`, { type: "PLAYING" })
    .catch(error => console.log(error));
});

client.on("ready", async () => {
  console.log('\x1b[33m%s\x1b[0m', '[REPLIT] CW Security Bot by: Alexander');
})
...
client.login("MTAxNDIxNTM0MTIwOTAzODg5OQ.GVaDqy.b3dkIIn5h1DKe3Jir0-MhuRxBnzwPlowdvm_LE");